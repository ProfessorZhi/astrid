...
def _print_usage() -> None:
    print(
        "astrid management commands\n\n"
        "astrid mcp list [--project]\n"
        "astrid mcp add <name> [--project] [--protocol <auto|content-length|newline-json>] [--env KEY=VALUE ...] -- <command> [args...]\n"
        "astrid mcp remove <name> [--project]\n\n"
        "astrid skills list\n"
        "astrid skills add <path-to-skill-or-dir> [--name <name>] [--project]\n"
        "astrid skills remove <name> [--project]"
    )
