...
def _install_launcher_script() -> str | None:
    ...
    if sys.platform == "win32":
        ...
        launcher_command = "astrid.bat"
    elif sys.platform == "darwin":
        # macOS: Use ~/.local/bin with bash script (also works with zsh)
        target_bin_dir = home / ".local" / "bin"
        launcher_path = target_bin_dir / "astrid-py"
...
def main() -> None:
    ...
    print()
    print("  Windows:")
    print("    astrid.bat               (如果已添加 PATH)")
    print("    python -m astrid.main    (通用方式)")
    print()
    print("  macOS:")
