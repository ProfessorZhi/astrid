...
# Add parent directory to path to import astrid
import sys
sys.path.insert(0, str(Path(__file__).parent.parent))

from astrid.context_manager import estimate_tokens, estimate_message_tokens
...
def benchmark_terminal_rendering() -> list[BenchmarkResult]:
    ...
    from astrid.tui.transcript import render_transcript
